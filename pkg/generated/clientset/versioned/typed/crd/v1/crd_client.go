...
import (
	v1 "k8s_crd_controller/pkg/apis/crd/v1"
	"k8s_crd_controller/pkg/generated/clientset/versioned/scheme"
	"net/http"
...
// CrdV1Client is used to interact with features provided by the crd.k8s.io group.
type CrdV1Client struct {
	restClient rest.Interface
}

func (c *CrdV1Client) Students(namespace string) StudentInterface {
