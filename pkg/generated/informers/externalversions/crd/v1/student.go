...
import (
	...
	internalinterfaces "k8s_crd_controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "k8s_crd_controller/pkg/generated/listers/crd/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdV1().Students(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1().Students(namespace).Watch(context.TODO(), options)
			},
		},
		&crdv1.Student{},
		resyncPeriod,
...
func (f *studentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdv1.Student{}, f.defaultInformer)
}
